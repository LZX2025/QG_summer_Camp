...
def main():
    ...
    json_path = '../data/cassava-leaf-disease-classification/label_num_to_disease_map.json'
    assert os.path.exists(json_path),"{} does not exist".format(json_path)
    with open(json_path, 'r') as f:
        cla_dict = json.load(f)

    im_path = '../data/cassava-leaf-disease-classification/test_images/2216849948.jpg'
